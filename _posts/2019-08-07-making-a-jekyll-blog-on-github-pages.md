...
After all these steps, it was possible to write by first blog post (<a href="#">this one</a>) with the following markdown.
````markdown
---
layout: post
title:  "Making a Jekyll Blog on GitHub Pages"
...
After all these steps, it was possible to write by first blog post (<a href="#">this one</a>) with the following markdown.
<img src="https://twrogers.github.io/assets/images/inception.jpeg">
